            ...
            <div className="cont_curso cont_educar row">
                <div className="cont_info_curso col-xl-7 col-md-7 col-sm-12">
                    ...
                    <div className="cont_texto">
                        ...
                        <div className="texto">Desde pequeña siempre tuve una afinidad y conexión especial con los perros. Por esa razón comencé a realizar paseos caninos con grupos reducidos con el fin de lograr un servicio personalizado y responsable. A partir de los paseos comenzaron a surgir problemáticas del estilo: "...el perro me salta, ¿qué puedo hacer?...", "...tira mucho de la correa...", "... si no sale a pasear rompe cosas en al casa...", y yo desde el desconocimiento no sabía qué responder. Fue por ese sin fin de preguntas que decidí adentrarme en el estudio del comportamiento canino.</div>
